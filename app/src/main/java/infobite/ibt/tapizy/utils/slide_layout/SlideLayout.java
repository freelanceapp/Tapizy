...
public class SlideLayout
    ...
    public static String isActionUp = "";
    private int mStartX;
    private int mStartY;
    float x1, x2, t1, y1, y2, t2;
                ...
                if (isDone) {
                    ...
                    if (x1 > x2) {
                        for (ISlideChangeListener listener : mChangeListeners) {
                            listener.onSetSwipeLitner(this, true, "left");
                        }
                        SlideLayout.isActionUp = "left";
                        Log.e("swipebg", "left");

                        //  Toast.makeText(getActivity(), "Left swipe", Toast.LENGTH_SHORT).show();
                    } else if (x2 > x1) {
                        for (ISlideChangeListener listener : mChangeListeners) {
                            listener.onSetSwipeLitner(this, true, "right");
                        }

                        SlideLayout.isActionUp = "right";
                        Log.e("swipebg", "right");
