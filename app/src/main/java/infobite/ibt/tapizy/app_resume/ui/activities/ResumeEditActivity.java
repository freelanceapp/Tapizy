...
public class ResumeEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (intent.getStringExtra(EXTRA_TYPE)) {
            case TYPE_PROJECT:
                setContentView(R.layout.activity_resume_edit_project);
                subtitleEnabled = false;
                getSupportActionBar().setTitle("Project");
                break;
            case TYPE_SCHOOL:
                setContentView(R.layout.activity_resume_edit_school);
                getSupportActionBar().setTitle("School");
                break;
            case TYPE_EXPERIENCE:
                setContentView(R.layout.activity_resume_edit_experience);
