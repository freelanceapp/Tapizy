...
import infobite.ibt.tapizy.adapter.TapiziLinearListAdapter;
import infobite.ibt.tapizy.app_resume.ui.activities.ResumeMainActivity;
import infobite.ibt.tapizy.constant.Constant;
import infobite.ibt.tapizy.model.TapizyLinearListModel;
...
public class ExploreActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.llResumeBot).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.lllayout:
                ...
                break;
            case R.id.llResumeBot:
                Intent intentB = new Intent(this, ResumeMainActivity.class);
