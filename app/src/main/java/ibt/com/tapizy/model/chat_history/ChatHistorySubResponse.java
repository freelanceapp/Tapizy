...
public class ChatHistorySubResponse implements Parcelable {
    ...
    public final static Parcelable.Creator<ChatHistorySubResponse> CREATOR = new Creator<ChatHistorySubResponse>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ChatHistorySubResponse createFromParcel(Parcel in) {
            return new ChatHistorySubResponse(in);
        }

        public ChatHistorySubResponse[] newArray(int size) {
            return (new ChatHistorySubResponse[size]);
        }

    };

    protected ChatHistorySubResponse(Parcel in) {
